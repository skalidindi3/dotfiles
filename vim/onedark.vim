" Vim TrueColor File based on Atom's One Dark Theme
" Name:       onedark.vim
" Based On:   https://github.com/joshdick/onedark.vim/
" Based On:   https://github.com/MaxSt/FlatColor/
" Based On:   https://github.com/noahfrederick/vim-hemisu/
"
" TODO: find where I found this so I can properly attribute this :'(
...
if $NVIM_TUI_ENABLE_TRUE_COLOR != 1 && !&termguicolors
  echom "This theme is only supported in truecolor mode!"
endif
...
" This function is based on one from onedark.vim, based on FlatColor, based on hemisu
...
let s:black             = { "gui": "#303340" }
let s:red               = { "gui": "#F9867B" }
let s:green             = { "gui": "#A3EFA0" }
let s:yellow            = { "gui": "#EEDD96" }
let s:blue              = { "gui": "#61AFEF" }
let s:purple            = { "gui": "#C57BDB" }
let s:cyan              = { "gui": "#56B6C2" }
let s:white             = { "gui": "#DFE3F8" }
let s:visual_grey       = { "gui": "#3E4452" }
let s:dark_red          = { "gui": "#BE5046" }
let s:dark_green        = s:green
let s:dark_yellow       = { "gui": "#D19A66" }
let s:dark_blue         = s:blue
let s:dark_purple       = s:purple
let s:dark_cyan         = s:cyan
let s:comment_grey      = { "gui": "#5C6370" }

let s:visual_black      = { "gui": "NONE"    }
let s:cursor_grey       = { "gui": "#2C323C" }
let s:menu_grey         = s:visual_grey
let s:special_grey      = { "gui": "#3B4048" }
let s:line_nr_fg        = { "gui": "#494D61" }
let s:line_nr_fg_active = { "gui": "#ADB8F1" }
let s:line_nr_bg_active = { "gui": "#363A4E" }
let s:vertsplit         = s:line_nr_fg
let s:statusline_bg     = s:line_nr_fg
...
call s:h("CursorLine", { "bg": s:line_nr_bg_active }) " the screen line that the cursor is in when 'cursorline' is set
...
call s:h("LineNr", { "fg": s:line_nr_fg }) " Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
call s:h("CursorLineNr", { "fg": s:line_nr_fg_active, "bg": s:line_nr_bg_active }) " Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
...
call s:h("StatusLine", { "fg": s:line_nr_fg_active, "bg": s:statusline_bg }) " status line of current window
call s:h("StatusLineNC", { "fg": s:comment_grey, "bg": s:statusline_bg }) " status lines of not-current windows Note: if this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
